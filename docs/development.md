...
Есть оставшийся backlog по очистке lint-замечаний. Новые изменения не должны добавлять предупреждения; при касании проблемного участка устраняйте относящееся к нему замечание без фиксации устаревшего численного счётчика.
