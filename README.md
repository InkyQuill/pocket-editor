...
- После выбора обычной папки Markdown порядок глав определяется детерминированно: по нормализованному пути. Позже его можно изменить действием «Изменить порядок глав» внутри «Содержания».
